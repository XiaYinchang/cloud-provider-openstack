module github.com/XiaYinchang/cloud-provider-openstack
...
require (
	...
	github.com/kubernetes-incubator/external-storage v5.3.0-alpha.1+incompatible // indirect
	...
	k8s.io/cloud-provider-openstack v0.3.0
	k8s.io/csi-api v0.0.0-20181109174433-f540d27a99d7 // indirect
	k8s.io/klog v0.2.0
	k8s.io/kube-controller-manager v0.0.0-20181108060033-90c1474b3e21 // indirect
